package com.imatalk.authservice.config;
...
public class KafkaProducerConfig {
    ...
    // create Topic "newFriendRequest"
    @Bean
    public NewTopic newFriendRequestTopic() {
        return TopicBuilder.name(NEW_REGISTERED_USER_TOPIC)
                .partitions(3) // TODO: store in application.properties
                .replicas(1)
                .build();
    }
